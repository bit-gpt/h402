...
// Union of all Solana-specific payload flavours.
// As of today we only support the simple broadcast flow, but this keeps the
// door open for future additions (e.g. delegated signing).
export type Payload = BroadcastPayload;
